    ...
    <head>
        ...
        <!-- CSS -->
        <link rel="stylesheet" href="../style/usersPage.css?v=<?php echo time() ?>">
    ...
    <body>
        ...
        <nav class="navigation">
            ...
            <ul class="proList w-100 p-2 list-group list-group-flush d-flex justify-content-center align-items-center">
                <li class="list-group-item m-2 list-unstyled"><a href="./userProfile.php"
                        class="link-dark text-decoration-none">Profile</a>
                </li>
                <li class="list-group-item m-2 list-unstyled"><a href="recentApp.php"
                        class="link-dark text-decoration-none">Appointments</a></li>
            ...
            <div class="mainBox container m-2 p-5">
                ...
                <div class="container d-flex justify-content-evenly align-items-center flex-wrap">
                    <div class="boxex w-25 h-50 m-3">
                        <a href="fDoctors.php"><button class="btn btn-light w-100 h-100 p-5 text-uppercase">Find a
                                doctor</button></a>
                    </div>
                    <div class="boxex w-50 h-50 m-3">
                        <a href="appointmentPage.php"><button class="btn btn-light w-100 h-100 p-5 text-uppercase">Book
                                an
                                appointment</button></a>
                    </div>
                    <div class="boxex w-50 h-50 m-3">
                        <a href="recentApp.php"><button class="btn btn-light w-100 h-100 p-5 text-uppercase">Recent
                                appointments</button></a>
                    </div>
                    <div class="boxex w-25 h-50 m-3">
                        <a href="#"><button class="btn btn-light w-100 h-100 p-5 text-uppercase">Seek
                                advice</button></a>
                    </div>
                </div>
